...
% using a PMU-recorded frequency signal for forced oscillation
% identification.
%
...
exportgraphics(fig, 'results/fig_case1_f_model-order.pdf', ...
...
exportgraphics(fig, 'results/fig_case1_f_residual-20.pdf', ...
    'ContentType', 'vector', 'BackGroundColor', 'none');
...
exportgraphics(fig, 'results/fig_case1_f_pole-diagram.pdf', ...
    'ContentType', 'vector', 'BackGroundColor', 'none');
