...
exportgraphics(fig, 'results/fig_case2_Im_model-order.pdf', ...
...
exportgraphics(fig, 'results/fig_case2_Im_residual-20.pdf', ...
    'ContentType', 'vector', 'BackGroundColor', 'none');
...
exportgraphics(fig, 'results/fig_case2_Im_pole-diagram.pdf', ...
    'ContentType', 'vector', 'BackGroundColor', 'none');
