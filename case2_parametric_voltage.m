...
exportgraphics(fig, 'results/fig_case2_Vm_model-order.pdf', ...
...
exportgraphics(fig, 'results/fig_case2_Vm_residual-20.pdf', ...
    'ContentType', 'vector', 'BackGroundColor', 'none');
...
exportgraphics(fig, 'results/fig_case2_Vm_pole-diagram.pdf', ...
    'ContentType', 'vector', 'BackGroundColor', 'none');
